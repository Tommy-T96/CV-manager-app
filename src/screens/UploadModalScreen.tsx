...
export default function UploadModalScreen() {
  ...
  const handleSaveCV = () => {
    ...
    if (Platform.OS === 'web') {
      ...
      if (
        confirm('CV has been successfully uploaded and parsed. View the CV details?')
      ) {
    ...
    <ScrollView
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionDescription}>
          Upload a CV in PDF, Word, or plain text format. The system will
          automatically extract and parse the information.
        </Text>
